...
$html .= '<thead><tr><th scope="col">ID</th><th scope="col">Nombre</th><th scope="col">Apellidos</th><th scope="col">Telefono</th><th scope="col">Vehiculo</th></thead>';
...
while ($linea = mysqli_fetch_array($datos)){
    ...
    $html .= '<td scope="row">'.$linea["vehiculo"].'</td>';
    $html .= '</tr>';
}
